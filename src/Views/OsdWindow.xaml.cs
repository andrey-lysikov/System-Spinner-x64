...
public partial class OsdWindow : Window
{
    ...
    public void Show(double percent, OsdKind kind, int steps)
    {
        ...
        // Shown before it is placed, since placing needs the handle the first show creates.
        // Nothing flashes: the panel comes up transparent and is shown once it stands right.
        if (!IsVisible)
        {
            base.Show();
